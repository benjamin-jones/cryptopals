...
print ("\n\nChallenge 2: XOR Encrpytion")
print(xor_string(test1, test2))

#Challenge 3
print ("\n\nChallenge 3: Single Byte XOR Encryption")
ciphertext = "1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"
single_xor_finder(ciphertext)

#Challenge 4
print("\n\nChallenge 4: Find Single Byte XOR Encryption")
largest = 0.0
cur_key = 0
cur_ptext = ""
cur_ctext = ""
...
new_ciphertext = base64.b64decode(open("./7.txt","r").read())

aes = AES.new("YELLOW SUBMARINE", AES.MODE_ECB)
print(aes.decrypt(new_ciphertext))
